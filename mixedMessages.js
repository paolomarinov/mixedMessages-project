...
function phraseGen(arr1, arr2, arr3) {
    ...
    return arr1[Math.floor(Math.random()*arr1.length + 1)] + ' ' + arr2[Math.floor(Math.random()*arr2.length)] + ' ' + arr3[Math.floor(Math.random()*arr3.length + 1)]

}

console.log(phraseGen(starters, middleSentences, enders))